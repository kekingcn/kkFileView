        ...
        public void run() {
            try {
                ...
                while (true) {
                    ...
                    ftpUsername = properties.getProperty("ftp.username", FtpConfigConstants.DEFAULT_FTP_USERNAME);
                    ftpPassword = properties.getProperty("ftp.password", FtpConfigConstants.DEFAULT_FTP_PASSWORD);
                    ftpControlEncoding = properties.getProperty("ftp.control.encoding", FtpConfigConstants.DEFAULT_FTP_CONTROL_ENCODING);
                    ...
                    MediaConfigConstants.setMediaValue(mediaArray);
                    ConfigConstants.setOfficePreviewTypeValue(officePreviewType);
                    FtpConfigConstants.setFtpUsernameValue(ftpUsername);
                    FtpConfigConstants.setFtpPasswordValue(ftpPassword);
                    FtpConfigConstants.setFtpControlEncodingValue(ftpControlEncoding);
                    ...
                    PDFConfigConstants.setPdfOpenFileDisableValue(pdfOpenFileDisable);
