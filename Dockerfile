...
ENV KKFILEVIEW_BIN_FOLDER /opt/kkFileView-2.1.1-SNAPSHOT/bin
ENTRYPOINT ["java","-Dfile.encoding=UTF-8","-Dsun.java2d.cmm=sun.java2d.cmm.kcms.KcmsServiceProvider","-Dspring.config.location=/opt/kkFileView-2.1.1-SNAPSHOT/conf/application.properties","-jar","/opt/kkFileView-2.1.1-SNAPSHOT/bin/kkFileView-2.1.1-SNAPSHOT.jar"]